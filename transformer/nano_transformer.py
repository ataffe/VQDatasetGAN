...
from transformer.nanoGPT.nanogpt import NanoGPT
...
class Net2NetTransformer(pl.LightningModule):
    def __init__(self,
        ...
        with torch.device("meta"):
            self.transformer: NanoGPT = instantiate_from_config(config=transformer_config)
    ...
    def configure_optimizers(self):
        return self.transformer.setup_optimizer()